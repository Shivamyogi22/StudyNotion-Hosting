    ...
    return (
        <div>
            ...
            <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
                ...
                {/* Then a paragraph */}
                <div className="w-[90%] text-center mt-4 text-richblack-300 font-bold text-lg">
                    With our online course, you can learn at your own pace, from
                    anywhere in the world, and get access to a wealth of
                    resources, including hands-on-projects, quizzes, and
                    personilised feedback from instructor.
                </div>
